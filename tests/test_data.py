...
def test_all_column_names_present(example_weather_data_columns):
    data = Data(example_weather_data_columns, Parameters(id_variable="Area", date_variable="Date", matching_variable="Mean_TemperatureF", start_match_period="2014-01-01", end_match_period="2014-10-01"))
    assert data.check_df == True
